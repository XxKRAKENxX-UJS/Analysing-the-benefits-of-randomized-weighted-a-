#Random Weighted A* on 8 Block Puzzle
...
startNode = np.array([[1, 9, 7], [4, 2, 3], [6, 5, 8]])

# startNode = np.array([[9, 4,3], [6,1,7], [2, 8, 5]])
